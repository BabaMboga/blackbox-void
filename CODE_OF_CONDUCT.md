...
are not aligned with this Code of Conduct, and will communicate reasons
...
be reported to the project maintainer via a GitHub issue marked
`conduct`, or by direct message if that's more comfortable. All
